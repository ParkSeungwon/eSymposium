		...
		<form id="index2" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="1" cellPadding="1" width="100%" border="0">
				<TR>
					...
					<TD bgColor="gainsboro" colSpan="2"><asp:imagebutton id="log" runat="server" ImageUrl="data/로그인2.gif"></asp:imagebutton><asp:imagebutton id="logout" runat="server" ImageUrl="data/로그아웃2.gif"></asp:imagebutton><asp:imagebutton id="sign" runat="server" ImageUrl="data/회원가입2.gif"></asp:imagebutton><asp:imagebutton id="change" runat="server" ImageUrl="data/정보변경2.gif"></asp:imagebutton><A href="board.aspx?field=notice"><IMG height="30" alt="" src="data/공지사항2.gif"></A>
						<A href="board.aspx?field=board"><IMG height="30" src="data/일반게시판2.gif" width="100"></A>
						<A href="boardlist.aspx"><IMG height="30" alt="" src="data/토론게시판2.gif"></A> <A href="group.aspx">
							<IMG alt="" src="data/그룹2.gif"></A> <A href="쪽지읽기.aspx"><IMG height="30" alt="" src="data/em3.bmp" width="30"></A>
